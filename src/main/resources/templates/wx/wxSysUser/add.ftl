...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="hidden" class="layui-input" name="openId" id="openId" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="socer"  placeholder="请输入积分">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="lastLoginTime" id="lastLoginTime"   lay-verify="date" placeholder="请选择最后登录时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="loginNum"  placeholder="请输入登录次数">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    layui.use(['form','jquery','layer','upload','laydate'],function(){
        ...
        form.on("submit(addWxSysUser)",function(data){
            ...
            $.post("${base}/wx/wxSysUser/add",data.field,function(res){
