...
<head>
    <meta charset="utf-8">
    <title>内容-轮播配置添加--${site.name}</title>
...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="checkbox" name="autoChange"  lay-skin="switch" value="1" lay-text="是|否" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="autoChangeTime"  placeholder="请输入自动切换时间间隔（毫秒）">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="animationTime"  placeholder="请输入滑动动画时长（毫秒）">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on("submit(addWxContentBroadcastConfig)",function(data){
            ...
            $.post("${base}/wx/wxContentBroadcastConfig/add",data.field,function(res){
                layer.close(loadIndex);
                if(res.success){
                    parent.layer.msg("内容-轮播配置添加成功！",{time:1000},function(){
