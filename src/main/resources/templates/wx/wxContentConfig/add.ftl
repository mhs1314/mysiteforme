...
<form class="layui-form" style="width:80%;">
    <div class="layui-form-item">
        <label class="layui-form-label">音视频自动播放 0关闭 1开启</label>
        <div class="layui-input-block">

            <input type="checkbox" name="openAudio"  lay-skin="switch" value="1" lay-text="是|否" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="checkbox" name="openComment"  lay-skin="switch" value="1" lay-text="是|否" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="checkbox" name="needExamine"  lay-skin="switch" value="1" lay-text="是|否" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="browseIntegralNum"  placeholder="请输入浏览文章增加积分">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="commentIntegralNum"  placeholder="请输入评论文章增加积分">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on("submit(addWxContentConfig)",function(data){
            ...
            $.post("${base}/wx/wxContentConfig/add",data.field,function(res){
