...
<form class="layui-form" style="width:80%;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <textarea name="openId"  placeholder="请输入用户唯一标识" class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="userName"  placeholder="请输入用户姓名">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="hidden" class="layui-input" name="userIcon" id="userIcon" >
            <div class="layui-upload">
                <button type="button" class="layui-btn" id="test_userIcon">上传用户头像</button>
                <div class="layui-upload-list">
                    <img class="layui-upload-img" id="demo_userIcon">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="addTime" id="addTime"   lay-verify="date" placeholder="请选择评论时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['form','jquery','layer','upload','laydate'],function(){
        ...
        form.on("submit(addWxContentComment)",function(data){
            ...
            $.post("${base}/wx/wxContentComment/add",data.field,function(res){
                layer.close(loadIndex);
                if(res.success){
                    parent.layer.msg("内容-评论添加成功！",{time:1000},function(){
